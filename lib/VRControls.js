			...
			{				
				if(vrInputs[ i ].isPresenting)
				{
					...
					object.quaternion.set( 
							ourFrameData.pose.orientation[0],
							ourFrameData.pose.orientation[1],
							ourFrameData.pose.orientation[2],
							ourFrameData.pose.orientation[3]);
					object.position.set( 
							ourFrameData.pose.position[0],
							ourFrameData.pose.position[1],
							ourFrameData.pose.position[2]);
				}
			}
			else
			{
